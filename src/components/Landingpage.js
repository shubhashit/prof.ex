            ...
            <div className='w-screen h-screen main ' onClick={removeSignUpForm}>
                ...
                <div id="LandingPageContent" className='flex  justify-evenly m-10 ' ref={centerContent}>
                    <div className='m-10 text-white p-2 flex flex-col justify-center items-center hide'>
                        <p className='text-3xl font-bold mb-3'>HEADING</p>
                        <p className='text-lg'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magni, nisi. Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim maiores sint quam qui numquam suscipit inventore asperiores dignissimos laboriosam explicabo.</p>
                        <button className='m-4 p-1 get-started-btn z-40' onClick={signupBox} >GET STARTED</button>
                    </div>
                ...
                <div className="custom-shape-divider-bottom-1677075985">
                    <svg className="h-40" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
